...
class Orphanges_screen extends StatelessWidget {
  const Orphanges_screen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final CollectionReference _user =
    FirebaseFirestore.instance.collection('Orphanges');
    return Scaffold(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => OrganizationProfile_screen(OrganizationName: documentSnapshot['Name'], CollectionName: 'Orphanges',)
                          ),
                        );
                      },
                      child: Column(
